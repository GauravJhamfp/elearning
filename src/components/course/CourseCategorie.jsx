...
const CourseCategorie = () => {
    const courseCategoriesStyle = {
        margin: '1px'
    }
    return (
        <div>
                                ...
                                <div className="row g-3">
                                    <div className="col-lg-12 col-md-12 wow zoomIn" data-wow-delay="0.1s">
                                        <Link className="position-relative d-block overflow-hidden" to="">
                                            ...
                                            <div className="bg-white text-center position-absolute bottom-0 end-0 py-2 px-3" style={courseCategoriesStyle}>
...
export default CourseCategorie